...
t17 = -t15;
t16 = -t13;
b = [tau1+dth2.*(t11+t12+t14+dth1.*l_AB.*l_OA.*m3.*t2.*2.0+dth2.*l_AB.*l_OA.*m3.*t2+dth1.*l_A_m2.*l_OA.*m2.*t2.*2.0+dth2.*l_A_m2.*l_OA.*m2.*t2+dth1.*l_AB.*l_OA.*m_motor.*t2.*2.0+dth2.*l_AB.*l_OA.*m_motor.*t2)+dth3.*(t7+t8+t9+t11+t12+t14)+Ir.*N.^2.*th1;t16+t17+tau2+dth2.*(t10+dth1.*l_AB.*l_OA.*m3.*t2+dth1.*l_A_m2.*l_OA.*m2.*t2+dth1.*l_AB.*l_OA.*m_motor.*t2)-dth2.*t10+dth3.*(t7+t8+t9+t10)-l_AB.*l_OA.*m3.*t2.*t5-l_A_m2.*l_OA.*m2.*t2.*t5-l_AB.*l_OA.*m_motor.*t2.*t5-dth1.*dth2.*l_AB.*l_OA.*m3.*t2-dth1.*dth2.*l_A_m2.*l_OA.*m2.*t2-dth1.*dth2.*l_AB.*l_OA.*m_motor.*t2;t16+t17+tau3-dth1.*t7-dth2.*t7+dth3.*(t10+dth1.*l_AB.*l_B_m3.*m3.*t3+dth2.*l_AB.*l_B_m3.*m3.*t3)-l_AB.*l_B_m3.*m3.*t3.*t5-dth2.^2.*l_AB.*l_B_m3.*m3.*t3-dth1.*dth2.*l_AB.*l_B_m3.*m3.*t3.*2.0];
