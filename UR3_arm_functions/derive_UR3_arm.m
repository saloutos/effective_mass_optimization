...
% actually, UR3 arm is the same topology as nominal arm??

%% Reference inertial parameters 

% First source: "https://www.universal-robots.com/articles/ur/application-installation/dh-parameters-for-calculations-of-kinematics-and-dynamics/"
% Second source: "https://github.com/ros-industrial/universal_robot/blob/kinetic-devel/ur_e_description/urdf/ur3e.urdf.xacro"
% Third source: "https://webthesis.biblio.polito.it/15519/1/tesi.pdf"
% Fourth source: "https://www.universal-robots.com/articles/ur/robot-care-maintenance/max-joint-torques/"

% Using parameters from UR3e

% % UR3 planar arm parameters
% m1 = 3.4445;            m2 = 1.437;
...
% p_UR3   = [m1 m2 m3 m_motor I1 I2 I3 I_motor Ir N l_O_m1 l_A_m2 l_B_m3 l_OA l_AB l_BC g]'; 
